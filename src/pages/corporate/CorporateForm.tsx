...
import { useFormContext, useFieldArray, useWatch, type SubmitHandler } from 'react-hook-form';
...
const CorporateFormFields = ({ isEditing, onCancel }: { isEditing: boolean, onCancel: () => void }) => {
