...
interface CorporatePackageItemProps {
    index: number;
    onRemove: () => void;
    items: CorporateBill['items'];
}

const CorporatePackageItem = ({ index, onRemove, items }: CorporatePackageItemProps) => {
    const { setValue } = useFormContext<CorporateBill>();
...
export default CorporatePackageItem;
